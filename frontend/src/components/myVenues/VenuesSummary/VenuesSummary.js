...
import VenuesSpenderModal from "./VenuesSpenderModal";
  ...
  return (
    <Card withBorder shadow="md">
      <VenuesSpenderModal
        opened={opened}
        setOpened={setOpened}
        payingCustomers={props.venueAggregates.payingCustomers}
      />
      <Group position="apart">
        <Text weight={600}>Your venues booking summary report</Text>
        <Box>
          <Button variant="light" onClick={() => setOpened(true)} mr={20}>
            Details
          </Button>
